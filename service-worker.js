const CACHE='erics-crm-v20260920-67';
const ASSETS=['./','./index.html','./style.css?v=20260920-67','./crm.css?v=20260920-67','./billing.js?v=20260920-67','./crm.js?v=20260920-67','./api-sync.js?v=20260920-67','./site.webmanifest','./ed-icon-192.png','./ed-icon-512.png','./assets/erics-designs-crm-logo.png'];
